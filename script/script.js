...
const projects = [
  ...
  },
  {
    ...
    title: 'BizConsult',
    tools: ['PHP', 'Laravel', 'MySQL', 'Database Diagram', 'JavaScript'], 
    description: 'is a comprehensive Laravel-based business consulting platform designed to help consulting firms and agencies manage their business operations efficiently. The platform features a bilingual interface (Arabic/English), a modern admin dashboard, and a responsive front-end website.',
